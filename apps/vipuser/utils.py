...
def access_user_print(email):
    ...
    try:
        ...
        if print_user:
            ...
            logger.info("access_user_print:%s",message)
        ...
        message['print_access_user']=print_access_list
        logger.info("print_access_user_set:%s",message)
    return message
...
def access_user_shared(email):
    ...
    try:
        ...
        if shared_user:
            ...
            logger.info("access_user_shared:%s",message)
    except Exception as e:
        ...
        message['shared_access_user']=shared_access_list
        logger.info("shared_access_user_set:%s",message)
    return message
